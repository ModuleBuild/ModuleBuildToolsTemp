...
FunctionsToExport = 'Convert-ArrayToString', 'Convert-HashToString', 
               ...
               'Get-SpecialPaths', 'New-CommentBasedHelp', 'New-DynamicParameter', 
               'New-PSGalleryProjectProfile', 'Out-Zip', 'Out-ZipFromFile', 
               'Script:Prompt-ForBuildBreak', 'Remove-Signature', 
