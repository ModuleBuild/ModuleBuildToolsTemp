#
# Module manifest for module 'ModuleBuildToolsTemp'
#
...
FunctionsToExport = 'Convert-ArrayToString', 'Convert-HashToString', 
               'Get-BuildEnvironment', 'Get-ErrorDetail', 'Get-ErrorInfo', 
               'Get-FunctionParameter', 'Get-SpecialPaths', 'New-CommentBasedHelp', 
               'New-DynamicParameter', 'New-PSGalleryProjectProfile', 'Out-Zip', 
               'Out-ZipFromFile', 'Prompt-ForBuildBreak', 'Remove-Signature', 
               'Replace-FileString', 'Set-BuildEnvironment', 
