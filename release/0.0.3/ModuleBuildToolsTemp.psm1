...
function Remove-MBTSignature
{
    ...
    .LINK
        https://github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.3/docs/Functions/Remove-MBTSignature.md
    #>
...
function Publish-MBTProjectToPSGallery {
    ...
    .EXTERNALHELP ModuleBuildToolsTemp-help.xml
    .LINK
        https://github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.3/docs/Functions/Upload-MBTProjectToPSGallery.md
    #>
    [CmdletBinding()]
...
function Get-MBTBuildEnvironment {
    ...
    .EXTERNALHELP ModuleBuildToolsTemp-help.xml
    .LINK
        https://github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.3/docs/Functions/Get-MBTBuildEnvironment.md
    #>
    [CmdletBinding()]
    param(
...
function Get-MBTFunctionParameter {
    ...
    .EXTERNALHELP ModuleBuildToolsTemp-help.xml
    .LINK
        https://github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.3/docs/Functions/Get-MBTFunctionParameter.md
    #>
    [CmdletBinding()]
    param(
...
function Out-MBTZip {
    ...
    .EXTERNALHELP ModuleBuildToolsTemp-help.xml
    .LINK
        https://github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.3/docs/Functions/Out-MBTZip.md
    #>
    param (
...
Function Get-MBTSpecialPath {
    ...
    .EXTERNALHELP ModuleBuildToolsTemp-help.xml
    .LINK
        https://github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.3/docs/Functions/Get-MBTSpecialPath.md
    #>
    Param (
...
Function Set-MBTBuildEnvironment {
    ...
    .EXTERNALHELP ModuleBuildToolsTemp-help.xml
    .LINK
        https://github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.3/docs/Functions/Set-MBTBuildEnvironment.md
    #>
...
function New-MBTDynamicParameter {
    ...
    .EXTERNALHELP ModuleBuildToolsTemp-help.xml
    .LINK
        https://github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.3/docs/Functions/New-MBTDynamicParameter.md
    #>
...
function New-MBTCommentBasedHelp {
    ...
    .EXTERNALHELP ModuleBuildToolsTemp-help.xml
    .LINK
        https://github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.3/docs/Functions/New-MBTCommentBasedHelp.md
    #>
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute("PSUseShouldProcessForStateChangingFunctions", "",Scope="function",Justification="")]
    param(
