...
function Remove-MBTSignature
{
    <#
        ...
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.6/docs/Remove-MBTSignature.md
        #>
...
function Get-MBTBuildEnvironment {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.6/docs/Get-MBTBuildEnvironment.md
        #>
    [CmdletBinding()]
    param(
...
function Get-MBTFunctionParameter {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.6/docs/Get-MBTFunctionParameter.md
        #>
    [CmdletBinding()]
    param(
...
function Out-MBTZip {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.6/docs/Out-MBTZip.md
        #>
    param (
...
Function Get-MBTSpecialPath {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.6/docs/Get-MBTSpecialPath.md
        #>
    Param (
...
Function Set-MBTBuildEnvironment {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.6/docs/Set-MBTBuildEnvironment.md
        #>
...
function New-MBTDynamicParameter {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.6/docs/New-MBTDynamicParameter.md
        #>
...
function New-MBTCommentBasedHelp {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.6/docs/New-MBTCommentBasedHelp.md
        #>
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute("PSUseShouldProcessForStateChangingFunctions", "",Scope="function",Justification="")]
    param(
