...
function Remove-MBTSignature
{
    <#
        ...
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.7/docs/Remove-MBTSignature.md
        #>
...
function Publish-MBTProjectToPSGallery {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.7/docs/Publish-MBTProjectToPSGallery.md
        #>
    [CmdletBinding()]
...
function Get-MBTBuildEnvironment {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.7/docs/Get-MBTBuildEnvironment.md
        #>
    [CmdletBinding()]
    param(
...
function Get-MBTFunctionParameter {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.7/docs/Get-MBTFunctionParameter.md
        #>
    [CmdletBinding()]
    param(
...
function Out-MBTZip {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.7/docs/Out-MBTZip.md
        #>
    param (
...
Function Get-MBTSpecialPath {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.7/docs/Get-MBTSpecialPath.md
        #>
    Param (
...
Function Set-MBTBuildEnvironment {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.7/docs/Set-MBTBuildEnvironment.md
        #>
...
function New-MBTDynamicParameter {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.7/docs/New-MBTDynamicParameter.md
        #>
...
function New-MBTCommentBasedHelp {
    <#
        .EXTERNALHELP ModuleBuildToolsTemp-help.xml
        .LINK
            https://www.github.com/justin-p/ModuleBuildToolsTemp/tree/master/release/0.0.7/docs/New-MBTCommentBasedHelp.md
        #>
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute("PSUseShouldProcessForStateChangingFunctions", "",Scope="function",Justification="")]
    param(
